import { RequestEnvelope } from '@amzn/halo-third-party-sdk-model';
...
describe('EventSignatureVerifier', () => {
    ...
    const testUrl: string = 'https://s3.amazonaws.com/healthtech.api/healthtech-api-cert-v000004.pem';
    const certUrl = url.parse(testUrl);
    const validPem: string = fs.readFileSync(`${__dirname }/../mocks/healthtech-api-cert-v000004.pem`).toString();
    ...
    const validSignature = 'WqDk9DSuaEK+dqSUlCUtST6YJryajm19d/b7D+gRS2pzUC25MiQwN+RlMefJV6kFhu9sZIhxHBi1mJFp'
    + '5OaI0i0w91KQXRETcTx5q7NdUPEQq/qe5hSAzyIl+3Yj8yv49ZUA0gVwE'
    + '6iYgZMeZNweJpKtLwlpDCa6oP0sOMfiEE7Dz8YgBgGVeTKhsbwTOZaXMs'
    + 'DXdhJa37sydqnRaJKeemCvKn795Izeqt+C+unWL50Hhex1ErDo/rsrqYj'
    + '04hXCdF+nz/D3Y+e7/TSykXVUscaSIkDHOQZYWL5hJ4bnK7XVUIPrOsEC'
    + '0pdCRmq9SWtTXuban6MwtVkzQStbxsX6aQ==';
    ...
    beforeEach(() => {
        sinon.useFakeTimers(new Date(2020, 12, 10));
    });
